...
def newton(satellite, I, T, rho):
    ...
    while (True):
        ...
        print(tempxyz)
        print(satellite)
        G = np.divide(tempxyz - satellite, diMat)
        G = np.c_[G, np.ones((5, 1))]
        print(G)
